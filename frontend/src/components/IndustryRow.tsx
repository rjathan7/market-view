...
export function IndustryRow({ rank, data }: IndustryRowProps) {
  ...
  return (
    <Link
      to={`/industry/${encodeURIComponent(data.industry)}`}
      className="grid grid-cols-[2.5rem_1fr_8rem_3.5rem_2rem] items-center gap-4 px-4 py-2.5 hover:bg-muted/50 transition-colors"
    >
